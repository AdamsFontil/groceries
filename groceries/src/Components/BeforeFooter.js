...
function BeforeFooter() {
  return (
    <div className='flex flex-col justify-evenly bg-gray-200 p-10' style={{ height: '55vh' }}>
      ...
      <div className='flex flex-row gap-5 mx-11'>
        <div>
          <img className='h-28 w-28 border rounded-full object-cover' src={customerService} alt='friendly customer service rep' />
        </div>
